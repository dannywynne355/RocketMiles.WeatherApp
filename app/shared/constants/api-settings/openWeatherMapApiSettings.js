    ...
    .constant('openWeatherMapApiSettings', {
        ...
        endpoints: {
            ...
            extendedForecast: {
                byCityName: {
                    method: 'GET',
                    url: 'forecast/daily?APPID={0}&q={1},{2}&units={3}',
                    withCredentials: false,
                    parameters: [
                        'token', 'city', 'countryCode', 'units'
                    ],
                ...
                byCityId: {
                    method: 'GET',
                    url: 'forecast/daily?APPID={0}&id={1}&units={2}',
                    withCredentials: false,
                    parameters: [
                        'token', 'cityId', 'units'
                    ],
                ...
                byGeolocation: {
                    method: 'GET',
                    url: 'forecast/daily?APPID={0}&lat={1}&lon={2}&units={3}',
                    withCredentials: false,
                    parameters: [
                        'token', 'longitude', 'latitude', 'units'
                    ],
                ...
                byZip: {
                    method: 'GET',
                    url: 'forecast/daily?APPID={0}&zip={1},{2}&units={3}',
                    withCredentials: false,
                    parameters: [
                        'token', 'zip', 'countryCode', 'units'
                    ],
